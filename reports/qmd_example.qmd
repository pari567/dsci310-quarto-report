...
We present the standard deviations in @tbl-horse-sd. The province with the largest spread in horse populations is `{python} largest_sd`.

Note that we define standard deviation (of a sample) as

$$s = \sqrt{\frac{\sum_{i=1}^N (x_i - \overline{x})^2}{N-1} }$$

Additionally, note that in @tbl-horse-sd. we consider the sample standard deviation of the number of horses during the same time span as @fig-horses.
